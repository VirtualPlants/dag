...
Ready to contribute? Here's how to set up `dag` for local development.

1. Fork the `dag` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/dag.git
...
3. The pull request should work for Python 2.7, 3.4, and 3.5. Check
   https://travis-ci.org/moi/dag/pull_requests
...
.. _issues: https://github.com/moi/dag/issues
