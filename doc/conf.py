...
# -*- coding: utf-8 -*-
#
# Package (Undefined, u'dag') documentation build configuration file, created by
...
texinfo_documents = [
    ('index', 'dag',
     ...
     u'Frederic Boudon',
     'dag',
     'Formalisation of DAG usage for plant modelling',
     'Miscellaneous'),
]
